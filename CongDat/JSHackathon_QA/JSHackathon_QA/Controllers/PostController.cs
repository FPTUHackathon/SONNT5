...
namespace JSHackathon_QA.Controllers
{
    public class PostController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var responseString = await client.GetStringAsync("http://localhost:51922/api/Posts/Get?tagID="+1002);
        ...
        public async Task<ActionResult> Post(int Post_id)
        {
            ...
            responseString = await client.GetStringAsync("http://localhost:51922/api/InPost/Get?Post_id=" + Post_id);
